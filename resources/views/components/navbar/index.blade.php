<nav class="bg-zinc-800">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-navbar.link href="/blog">Blog</x-navbar.link>
    ...
    <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            <x-navbar.dropdown-menu href="/">Home</x-navbar.dropdown-menu>
            <x-navbar.dropdown-menu href="/about">About</x-navbar.dropdown-menu>
            <x-navbar.dropdown-menu href="/blog">Blog</x-navbar.dropdown-menu>
            <x-navbar.dropdown-menu href="/contact">Contact</x-navbar.dropdown-menu>
        </div>
    </div>
</nav>
